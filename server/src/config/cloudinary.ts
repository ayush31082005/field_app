...
cloudinary.config({
  cloud_name: process.env.CLOUDINARY_CLOUD_NAME || 'dvssokckw',
  api_key: process.env.CLOUDINARY_API_KEY || '426588441797434',
  api_secret: process.env.CLOUDINARY_API_SECRET || '38HWMATaHGUxs4i3PpnW2Fh_fDw',
  secure: true,
});
